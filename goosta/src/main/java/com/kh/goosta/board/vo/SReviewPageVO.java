...
public class SReviewPageVO {

	public static final int PAGE_SCALE = 5; //페이지당 게시물수
	public static final int BLOCK_SCALE = 5; //불록당 페이지수
	...
	//생성자	10 1
	public SReviewPageVO(int count, int curPage){
		...
		setBlockRange();	//현재 페이지 블록의 시작페이지, 끝 페이지 번호 계산 
	}
	...
	public void setTotBlock() {
		//페이지 블록 갯수 : 57페이지 / 5블록 - >11.4 -> 12개 블록

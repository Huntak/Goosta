...
<table id="contents" cellspacing="0">
	...
	<tr><td class="menu"><label>신고횟수</label></td><td class="item2"><input type="number" name="memberreport" value="${m.memberreport }"/></td></tr>
...
<a href="mmdelete.do?memberid=${m.memberid }" class="btn-ctm btn-blue"><span>탈퇴</span></a>

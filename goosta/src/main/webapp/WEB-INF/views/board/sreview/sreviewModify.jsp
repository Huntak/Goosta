...
#reviewWriteDiv #reviewWriteBottom #modifyButton:focus {
	outline: none;
}
...
$(function(){
	...
	var starquantity = $("#starquantity").val();
	$(".star").each(function(){
		if($(this).val() == starquantity){
...
<section>
	...
	<div id="reviewWriteDiv">
		<form action="sreviewModify.do" method="get" id="insertSReview">
			<table>
				<colgroup>
					<col width="200">
					<col width="*">
				...
				<tr>
					<td>제목</td>
					<td><input type="text" id="reviewTitleInput" name="boardtitle" value="${ vo.boardtitle }"></td>
				</tr>
				<tr>
					<td>작성자</td>
					<td><input type="text" id="reviewWriterInput" name="boardwriter" value="${ vo.boardwriter }" readonly></td>
				</tr>
				<tr>
					<td>별점</td>
					<td>
						<input type="hidden" value="${ vo.starquantity }" id="starquantity">
						...
						<input type="radio" class="star" name="starquantity" value="1.0">
						...
						<input type="radio" class="star" name="starquantity" value="2.0">
						...
						<input type="radio" class="star" name="starquantity" value="3.0">
						...
						<input type="radio" class="star" name="starquantity" value="4.0">
						...
						<input type="radio" class="star" name="starquantity" value="5.0">
				...
				<tr>
					<td>내용</td>
					<td><textarea id="reviewContentTextarea" name="boardcontent">${ vo.boardcontent }</textarea></td>
				</tr>
				<tr>
					<td>사진 업로드</td>
			...
			<div id="reviewWriteBottom">
				...
				<input type="submit" id="modifyButton" value="Modify">
				<a href="sreview.do" id="cancelButton">Cancel</a>
			</div>
		</form>
	</div>
</section>

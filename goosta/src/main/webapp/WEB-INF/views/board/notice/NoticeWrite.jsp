...
<!-- CSS -->
	...
	<link href="resources/css/notice/noticeWrite.css" rel="stylesheet" type="text/css" />
...
$(document).ready(function(){
	...
	$("#insertnotice").submit(function(e) {
		if($("#title").val()==''){
			alert("제목을 입력하십시오.");
			e.preventDefault();
		}else if($("#content").val() == ''){
...
<c:import url="/WEB-INF/views/common/header.jsp"></c:import>
	...
	<div class="cont758">
		...
		<form action="noticeInsert.do" method="get" id="insertnotice">
			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td class="td_con">
							<textarea name="boardcontent" id=noticent"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
				<div class="btn-area">
				<input type="submit" class="btn-ctm btn-blue" value="글쓰기">
				</div>
		</form>
	</div>

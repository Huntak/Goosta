...
<!-- CSS -->
	...
	<link href="resources/css/notice/noticeDetail.css" rel="stylesheet" type="text/css" />
...
<c:import url="/WEB-INF/views/common/header.jsp"></c:import>
	...
	<div class="cont758">
		...
		<form>
			...
			<table class="content">
				<tbody>
					...
					<tr>
						...
						<td class="td_con">
							<span style="position: relative; left: 13px;">${loginUser.memberid }</span>
						</td>
					</tr>
					<tr>
			...
			<div class="btn-area">
					<a href="noticeDelete.do" class="btn-ctm btn-blue" style="text-decoration: none;"><span class="clickButton">삭제</span></a>
					<a href="noticeModifyView.do?boardno=${vo.boardno }" class="btn-ctm btn-blue" style="text-decoration: none;"><span class="clickButton">수정</span></a>
				<a href="notice.do?curPage=${curPage }" class="btn-ctm btn-blue" style="text-decoration: none;"><span class="clickButton">목록</span></a>
			</div>
		</form>
	</div>

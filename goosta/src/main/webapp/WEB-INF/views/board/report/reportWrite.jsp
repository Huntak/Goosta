...
$(document).ready(function(){
	...
	$("#insertReport").submit(function(e) {
		if($("#title").val()==''){
			alert("제목을 입력하십시오.");
			e.preventDefault();
...
<c:import url="/WEB-INF/views/common/header.jsp"></c:import>
	...
	<div class="cont758">
		...
		<form action="reportInsert.do" method="get" id="insertReport">
			<input type="hidden" name="boardwriter" value="오송하">
			<input type="hidden" name="boardtypeno" value="5">
			<table>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td class="td_con">
							<select class="selecttd" name="reportreason">
								...
								<option value="중고거래사기">중고거래사기</option>

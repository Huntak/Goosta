...
<c:import url="/WEB-INF/views/common/header.jsp"></c:import>
	<div class="container-fluid">
		...
		<table id="submenu_table">
			<tr id="submenu_tr">
				<th><a href="viewfaq.do">전체</a></th>
				<th><a href="faqType.do?answertype=배송">배송</a></th>
				<th><a href="faqType.do?answertype=주문">주문/결제</a></th>
				<th><a href="faqType.do?answertype=교환" style="background:#027dbf; color:white;">교환/반품</a></th>
...
<a href="faqType.do?pageNumber=1&answertype=교환&keyword=${keyword}">◀</a>
<c:if test="${startPage>1}"> 
<a href="faqType.do?pageNumber=${startPage-1}&answertype=교환&keyword=${keyword}">◀</a>
</c:if>
<c:if test="${startPage<=1}"> 
<a href="">◀</a>
</c:if>
...
<a href="faqType.do?pageNumber=${i}&answertype=교환&keyword=${keyword}">${i}</a> 
</c:when>
<c:otherwise>
<a href="faqType.do?pageNumber=${i}&answertype=교환&keyword=${keyword}" >${i}</a> 
</c:otherwise>
...
<a href="faqType.do?pageNumber=${endPage+1}&answertype=교환&keyword=${keyword}">▶</a>
</c:if>
<c:if test="${endPage >= totalPageCount}">
<a href="#">▶</a>
</c:if>
<a href="faqType.do?pageNumber=${totalPageCount}&answertype=교환&keyword=${keyword}">▶</a>
</td>
</tr>
</table>
</div>
...
<!-- 검색 기능  -->		
 <div id="search_div">
	<form action="faqSearchType.do" method="post">
	<input type="hidden" name="answertype" value="교환">

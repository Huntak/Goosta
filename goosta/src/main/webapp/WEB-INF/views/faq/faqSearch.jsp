...
<a href="faqSearch.do?pageNumber=1&keyword=${keyword}">◀</a>
<c:if test="${startPage>1}"> 
<a href="viewfaq.do?pageNumber=${startPage-1}&keyword=${keyword}">◀</a>
</c:if>
<c:if test="${startPage<=1}"> 
<a href="">◀</a>
</c:if>
...
<a href="faqSearch.do?pageNumber=${i}&keyword=${keyword}">${i}</a> 
</c:when>
<c:otherwise>
<a href="faqSearch.do?pageNumber=${i}&keyword=${keyword}" >${i}</a> 
</c:otherwise>
...
<a href="faqSearch.do?pageNumber=${endPage+1}&keyword=${keyword}">▶</a>
</c:if>
<c:if test="${endPage >= totalPageCount}">
<a href="#">▶</a>
</c:if>
<a href="faqSearch.do?pageNumber=${totalPageCount}&keyword=${keyword}">▶</a>
</td>
</tr>
</table>
</div>

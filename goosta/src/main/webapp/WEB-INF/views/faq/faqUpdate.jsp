...
<c:import url="/WEB-INF/views/common/header.jsp"></c:import>
	<div class="cont758">
		...
		<input type="hidden" value="${faq.fid }" name="fid">
			<table>
				<tbody>
					<tr>
						<th class="th_title">제목</th>
						<td class="td_con">
							<input type="text" id="title" name="ftitle" value="${faq.ftitle }" maxlength="100"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="td_con">
							<textarea name="fcontent" id="boardcontent">${faq.fcontent }</textarea>
						</td>
					</tr>
				</tbody>
			</table>

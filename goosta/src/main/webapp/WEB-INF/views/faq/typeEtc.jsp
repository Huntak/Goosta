	...
	<div class="container-fluid">
		...
		<table id="submenu_table">
			<tr id="submenu_tr">
				...
				<th><a href="faqType.do?answertype=기타" style="background:#027dbf; color:white;">기타</a></th>
			</tr>
		</table>
		<table id="faq_table">
...
<a href="faqType.do?pageNumber=1&answertype=기타&keyword=${keyword}">◀</a>
<c:if test="${startPage>1}"> 
<a href="faqType.do?pageNumber=${startPage-1}&answertype=기타&keyword=${keyword}">◀</a>
</c:if>
<c:if test="${startPage<=1}"> 
<a href="">◀</a>
</c:if>
...
<a href="faqType.do?pageNumber=${i}&answertype=기타&keyword=${keyword}">${i}</a> 
</c:when>
<c:otherwise>
<a href="faqType.do?pageNumber=${i}&answertype=기타&keyword=${keyword}" >${i}</a> 
</c:otherwise>
...
<a href="faqType.do?pageNumber=${endPage+1}&answertype=기타&keyword=${keyword}">▶</a>
</c:if>
<c:if test="${endPage >= totalPageCount}">
<a href="#">▶</a>
</c:if>
<a href="faqType.do?pageNumber=${totalPageCount}&answertype=기타&keyword=${keyword}">▶</a>
</td>
</tr>
</table>
</div>
...
<!-- 검색 기능  -->		
 <div id="search_div">
	...
	<input type="hidden" name="answertype" value="기타">

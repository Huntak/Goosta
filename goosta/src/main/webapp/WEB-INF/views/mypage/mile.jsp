...
<div class="cat_order">
		  		<div class="mycat">
							<h1><img alt="마이페이지" src="resources/images/mypage/mypage.gif"></h1>
				</div>
				
				<!-- /mypage_point -->
				<h2 class="tit3">마일리지 사용/적립 내역</h2>
				
				
				<!-- orderList -->	
				</p><div class="orderList" style="margin-top: 10px; height: 800px; overflow:auto;">
							<table summary="주문번호, 상품, 수량, 주문금액, 주문상태에 따른 조회된 주문내역 정보">
						        ...
						        <tbody><!-- tbody 추가 #nike -->
									 <c:forEach items="${list }" var="list">
										<tr>
											...
											<td>${ list.mileageminus}  점</td>
											<td>${ list.mileageplus}  점</td>
											<td>&nbsp;</td>
										</tr>	
									 </c:forEach> 
								...
								<td></td>
								<td></td>
								<td>${loginUser.membertotalmileage } 점</td>
								</tr>
								</tfooter>
							</table>

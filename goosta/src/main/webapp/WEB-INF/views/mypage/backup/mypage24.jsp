...
<!-- 	<link href="resources/css/footer/jquery.scrolltop.css" rel="stylesheet" type="text/css" />
 -->	
...
<div class="container">
        ...
        <div id="sidebar">
           <ul>
			...
			<ul>
				...
				<li><a href="/mypage/mile">나의 MiLE</a></li>
        ...
        <div class="main-content">
          ...
          <div class="content">
		  	...
		  	<div class="cat_order">
		  		<div class="mycat">
							<h1><img alt="마이페이지" src="images/mypage/mypage.gif"></h1>
				</div>
				<!-- mypage_point주문결제횟수 -->
				...
				<div class="join3">
								<div class="fL">
									<span id="spn_search">
										<strong>기간별조회</strong>
										<img id="btn_period1" style="cursor: pointer;" alt="3일" src="resources/images/mypage/3.gif" val="3day">
										<img id="btn_period1" style="cursor: pointer;" alt="7일" src="resources/images/mypage/7.gif" val="7day">
										<img id="btn_period1" style="cursor: pointer;" alt="15일" src="resources/images/mypage/15.gif" val="15day">
										<img id="btn_period1" style="cursor: pointer;" alt="1개월" src="resources/images/mypage//1.gif" val="1month">
										<img id="btn_period1" style="cursor: pointer;" alt="3개월" src="resources/images/mypage/3m.gif" val="3month">
									</span>
								</div>
								<div class="fR">
									<span>
										...
										<img src="resources/images/mypage/schedule.gif" style="cursor: pointer;" alt="달력"><input type="hidden" id="hdStartDate">
										...
										<img src="resources/images/mypage/schedule.gif" style="cursor: pointer;" alt="달력"><input type="hidden" id="hdEndDate">
										<img src="resources/images/mypage/check.gif" style="cursor:pointer;" alt="조회하기" id="btnSearch">
									</span>
								</div>
							</div>
				<p class="cn_tex">
				...
				<p>주문번호 클릭 시 배송지, 결제정보를 확인 할 수 있습니다.<p>
				...
				<div class="orderList" style="margin-top: 10px;">
							<table summary="주문번호, 상품, 수량, 주문금액, 주문상태에 따른 조회된 주문내역 정보">
						        ...
						        <tbody><!-- tbody 추가 #nike -->
										...
										<tr>
											<td class="lns01" colspan="5"><strong>최근 <span id="txt_period2">15일</span>간 주문내역이 없습니다.</strong></td>
										</tr>	

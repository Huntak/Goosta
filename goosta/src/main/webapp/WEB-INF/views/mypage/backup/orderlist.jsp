        ...
        <div class="main-content">
          ...
          <div class="content">
		  	...
		  	<div class="cat_order">
				...
				<!-- /mypage_point -->
				<h2 class="tit3"><img src="../image/order.gif"></h2>
				...
				<div class="join3">
								<div class="fL">
									<span id="spn_search">
										<strong>기간별조회</strong>
										<img id="btn_period1" style="cursor: pointer;" alt="3일" src="images/mypage/3.gif" val="3day">
										<img id="btn_period1" style="cursor: pointer;" alt="7일" src="images/mypage/7.gif" val="7day">
										<img id="btn_period1" style="cursor: pointer;" alt="15일" src="images/mypage/15r.gif" val="15day">
										<img id="btn_period1" style="cursor: pointer;" alt="1개월" src="images/mypage/1.gif" val="1month">
										<img id="btn_period1" style="cursor: pointer;" alt="3개월" src="images/mypage/3m.gif" val="3month">
									</span>
								</div>
								<div class="fR">
									<span>
										...
										<img src="images/mypage/schedule.gif" style="cursor: pointer;" alt="달력"><input type="hidden" id="hdEndDate">
										<img src="images/mypage/check.gif" style="cursor:pointer;" alt="조회하기" id="btnSearch">
									</span>
								</div>
							</div>
				<p class="cn_tex">

...
<link href="resources/css/bootstrap/bootstrap.min.css" rel="stylesheet"
	media="screen">
<link href="resources/css/customer/shopNoticeDetail.css?ver=1	" rel="stylesheet"
	media="screen">
...
<table id="faqDetail_table">
	<tr id="faqDetail_tr">
		<td>&nbsp;&nbsp;&nbsp;${snv.boardtitle }</td>
		<td>작성일&nbsp;&nbsp;<span>${snv.boarddate }</span></td>
		<td>조회수&nbsp;&nbsp;<span>${snv.readcount }</span></td></tr>
	<tr><td id="faqContent_td" colspan="3">
	<c:if test="${!empty snv.boardimage1 }"><div id="image_div"><image src="resources/uploadFiles/${snv.boardimage1 }"></image></div></c:if>
	<div id="faqContent_div">${snv.boardcontent }</div></td></tr>
</table>
<div id="btn_div">
<a id="toListBtn2" href="viewShopNotice.do">목록</a>
<c:if test="${!empty loginUser }"><a id="toListBtn1" href="viewShopNoticeUpdate?boardno=${snv.boardno }">수정</a></c:if>
</div>
</div>

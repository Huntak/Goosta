...
<c:import url="/WEB-INF/views/common/header.jsp"></c:import>
	<div class="cont758">
		...
		<form action="shopNoticeUpdate.do" method="post" enctype="multipart/form-data">
		<input type="hidden" value="${loginUser.memberid }" name="boardwriter">
		<input type="hidden" value="${notice.boardno }" name="boardno">
			<table>
				<tbody>
					<tr>
						<th class="th_title">제목</th>
						<td class="td_con">
							<input type="text" id="title" value="${notice.boardtitle }"name="boardtitle" maxlength="100"/>
						</td>
					</tr>
					<tr>

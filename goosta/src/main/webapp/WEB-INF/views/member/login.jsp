...
<div class="login-content" id="contents_r">
	...
	<div class="id-area">
	<div class="id_input">
	<input type="text" name="memberid" placeholder="아이디"></div>
	</div>
	<div>
	<div class="pwd_input">
	<input type="password" name="memberpwd" placeholder="비밀번호"></div>
	</div>
	<div id="error"><span>아이디 또는 비밀번호가 일치하지 않습니다.</span></div>
	<div class="chk-area">
	<input type="checkbox" name="id-save" class="id-save" id="idSaveCheck">아이디저장 <a href="findid1.do" class="btn-find">아이디/비밀번호 찾기</a>
	</div>
